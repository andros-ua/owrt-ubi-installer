## An OpenWrt UBI Installer Image Generator for CMCC RAX3000M(e)
...
5. Flash `openwrt-[version]-mediatek-filogic-cmcc_rax3000m-ubi-initramfs-recovery-installer.itb` via sysupgrade.

6. Once OpenWrt initramfs system comes up, do sysupgrade using
   `openwrt-[version]-mediatek-filogic-cmcc_rax3000m-ubi-squashfs-sysupgrade.itb`
